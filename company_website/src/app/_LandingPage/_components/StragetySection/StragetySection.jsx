  ...
  return (
    <>
      <div
        ...
        className="flex flex-col bg-gray-400 lg:flex-row items-center p-8 py-16 relative overflow-hidden"
      >
        <TitleSection
          caseStudy={caseStudy}
...
//   useEffect(() => {
//     // Lock the body scroll only during the case study transitions
//     if (
//       currentCaseStudyIndex < caseStudyData.length - 1 &&
//       interactionTriggered
//     ) {
...
//     };
//   }, [currentCaseStudyIndex, interactionTriggered]);
...
//       if (currentCaseStudyIndex === caseStudyData.length - 1) {
//         // Unlock scrolling after the last case study
//         setTimeout(() => {
//           setScrollTriggered(false);
//           setInteractionTriggered(false);
//         }, 800);

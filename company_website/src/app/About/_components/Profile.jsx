...
// }) => {
//   return (
//     <div className="max-w-xl   p-6 border-t border-b border-r border-black ">
//       {/* Profile Image */}

//       <div className="flex space-x-12 ">
//         <div className="relative w-[250px] h-60  overflow-hidden">
//           <Image
//             src={profileImage}
//             alt={name}
//             layout="fill"
...
//               {yearsOfExperience}+
//             </h2>
//             <p className="text-xs mt-1 font-light  font-jakarta">
//               Years of Experience
//             </p>
//           </div>
//         </div>
...
//       <div className="mt-4 text-xs font-jakarta">{description}</div>

//       <div className="mt-4 text-xs font-jakarta">{additionalInfo}</div>
